...
PARSERS = {
    ...
    "agency_habitat_ar": tokko_agency.parse_detail_habitat,
    "agency_newport_uy": tokko_agency.parse_detail_newport,
    "agency_marcaraices_uy": agency_marcaraices_uy.parse_detail,
}
