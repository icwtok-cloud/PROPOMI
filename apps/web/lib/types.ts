export type Property={id:string;title:string;zone:string;city:string;operation:string;type:string;price:number;currency:string;bedrooms?:number;bathrooms?:number;surface?:number;parking?:boolean;amenities?:string[];freshness?:string;origin_published_at?:string;source?:string;source_url?:string;image?:string;images?:string[];description?:string;agency_id?:string;contact_phone_raw?:string|null;listing_group_id?:string|null;needs_review?:boolean;possible_duplicate_of?:string|null};
