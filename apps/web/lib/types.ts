...
export type Agency={id:string;name:string;city:string;verified:boolean;claimed:boolean;phone?:string|null;verificationStatus?:string;instagram?:string|null;websiteLink?:string|null;freeLeadsRemaining?:number};
