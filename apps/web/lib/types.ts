...
export type LeadIntentType='QUESTION'|'VISIT';
export type Lead={id:string;user_id:string;property_id:string;intent_type:LeadIntentType;has_proposal:boolean;amount?:number|null;currency:string;payment_form?:string|null;capital?:number|null;timeframe?:string|null;comment?:string|null;visit_day?:string|null;visit_slot?:string|null;status:string;created_at:string;contact_revealed:boolean;origin?:string|null;property_title?:string|null;property_zone?:string|null;listing_group_id?:string|null;buyer_name?:string;buyer_phone?:string;buyer_email?:string};
