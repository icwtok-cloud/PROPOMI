...
export default function Home(){
  ...
  useEffect(()=>{
    // Nunca auto-seleccionar zona: solo limpiar si la zona elegida quedó
    // stale (no pertenece a la ciudad actual). El usuario elige zona a mano;
    // dejarla vacía = buscar en toda la ciudad (evita "solo 21 resultados"
    // por quedar pegado en una única zona de fábrica).
    if(!city){
      if(zone) setZone('');
      return;
    }
